...
ALLOWED_HOSTS = getenv("DJANGO_ALLOWED_HOSTS", "127.0.0.1,localhost,biasbreaker-a2l8.onrender.com,persuasive.research.cs.dal.ca").split(",")
...
DJOSER = {
    ...
    'SOCIAL_AUTH_ALLOWED_REDIRECT_URIS': [
        uri.strip() for uri in getenv('REDIRECT_URIS', '').split(",") if uri.strip()
    ]
}
...
#     "http://localhost:3000",
#     "http://127.0.0.1:3000",
#     "https://biasbreaker-1.onrender.com"
# ]
