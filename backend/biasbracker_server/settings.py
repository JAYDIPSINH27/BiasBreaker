...
ALLOWED_HOSTS = getenv("DJANGO_ALLOWED_HOSTS", "127.0.0.1,localhost,biasbreaker-a2l8.onrender.com,persuasive.research.cs.dal.ca,biasbreaker-backend.loca.lt").split(",")
